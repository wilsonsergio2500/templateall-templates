...
import { {Name_pascalized}SetAsLoadingAction, {Name_pascalized}SetAsDoneAction, {Name_pascalized}CreateAction, {Name_pascalized}UpdateAction, {Name_pascalized}LoadItemsAction, {Name_pascalized}SetPaginatorAction, {Name_pascalized}PaginateItemsAction, {Name_pascalized}RemoveAction, {Name_pascalized}GetByIdAction } from './{Name_file}.actions';
